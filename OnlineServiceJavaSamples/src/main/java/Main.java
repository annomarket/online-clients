...
public class Main {
	...
	//The URL of the AnnoMarket Online Processing Service Endpoint
	private static String endpointUrl = "https://api.annomarket.com/online-processing/item/";
	//The shop item which will be used for processing
	private static String shopItemId = "2";
	
	//API Keys
	//TODO set your own credentials generated from annomarket.com
	...
	/**
	 * Serialize a ProcessingRequest and send it to AnnoMarket Online Processing Service
